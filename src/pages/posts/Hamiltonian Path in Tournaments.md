...
### Problem Statement
Consider an array of **n** distinct integers. We need to a local minimas in the array. A local minima is defined as an element in the array which is less than its neighbors.
